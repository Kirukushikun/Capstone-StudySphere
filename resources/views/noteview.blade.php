        ...
        <div class="noteTaking">
            <div class="container1">
                ...
                <form action="{{route('note.view.update', $view->id)}}" method="POST">
                    ...
                    @method('PATCH')
                    <div class="inputs">
                        <input type="text" name="title" placeholder="Title" value="{{$view->title}}" required>
                        <input type="text" name="subject" placeholder="Subject"     value="{{$view->subject}}" required>
                    </div>
            ...
            <div class="container2">
                ...
                <div class="contents">
                    ...
                    <div class="btns">
                        <button onclick="location.href='{{route('note.view', $note->id)}}'"><i class='bx bx-show'></i></button>
